...
const floormat = 500;
const navigationsystem = 1000;
const heatedseat = 500;
const warranty = 2500;
...
//mats
const answer1 = prompt("Do you want floor mats? (yes/no): ");
...
//Navigation system
const answer2 = prompt("Do you want a navigation system? (yes/no): ");
...
const answer3 = prompt("Do you want heated leather seats? (yes/no): ");
...
//Warrenty
const answer4 = prompt("Do you want the 5-year extended warranty? (yes/no): ");
